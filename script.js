    ...
    matchedArticles.forEach(item => {
        ...
        card.innerHTML = `
            <div class="card-header">
                ...
                <div class="card-header-right">${typeHtml}<div class="badge-num"><span class="badge-num-text">ст. ${highlightedNum}</span><svg class="badge-copy-icon" width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="9" width="12" height="12" rx="2" stroke="currentColor" stroke-width="2"/><path d="M15 9V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3" stroke="currentColor" stroke-width="2"/></svg></div></div>
            </div>
...
function renderAsList(container, matchedArticles, isSearching, searchWords) {
    matchedArticles.forEach(item => {
        ...
        const leftHtml = `
            ${typeHtml}
            <div class="row-num row-slot-num"><div class="badge-num"><span class="badge-num-text">ст. ${highlightedNum}</span><svg class="badge-copy-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="9" width="12" height="12" rx="2" stroke="currentColor" stroke-width="2"/><path d="M15 9V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3" stroke="currentColor" stroke-width="2"/></svg></div></div>
